		...
		<aside>
			<h4>마이페이지</h4>
				<ul class="nav nav-pills flex-column" id="myPageName" style="width: 200px">
					<li class="nav-item"><a class="nav-link active bg-success" href="#">회원정보 수정</a></li>
	                 <li class="nav-item"><a class="nav-link " href="#">구매내역</a></li>
	                 <li class="nav-item"><a class="nav-link" href="#">내가 남긴 상품문의 조회</a></li>
	                 <li class="nav-item"><a class="nav-link" href="#">내가 남긴 후기 조회</a></li>
