...
<div class="header">
 ...
 <div class="container mb-5 mainbody" style="margin-top:240px;">
   <form class="mform business" name="joinform" action="${pageContext.request.contextPath}/main/joinProcess" method="post">
	<h1>기업 회원가입</h1>
	<hr>
	...
	<input type="text" class="jinput" id="regnum" name="member_regnum" placeholder="Ex) 1234567890" maxlength="10" style="width:305px" required value="1208806529">
	...
	<input type="text" class="jinput inputText" name="member_btype" placeholder="업종을 선택해주세요" style="width:268px" required readOnly  onkeyup="noSpaceForm(this);" onchange="noSpaceForm(this);" >
